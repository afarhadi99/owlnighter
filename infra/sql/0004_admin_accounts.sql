-- ============================================================================
-- owlnighter — 0004 admin accounts
-- Self-contained admin-panel operator accounts and sessions, used by the
-- Fastify admin API for authentication independent of Supabase Auth.
-- ============================================================================
...
create unique index if not exists admin_accounts_email_lower_idx on public.admin_accounts (lower(email));
...
create index if not exists admin_sessions_account_idx on public.admin_sessions (admin_account_id);
